...
abstract contract DPexERC20 is IUniswapV2ERC20 {
    using SafeMath for uint;

    string public constant override name = "Decentralized Passive Exchange Pair";
    string public constant override symbol = "DPEX";
